...
#' @param min_value1 Allows the user to customize the value for column1 that gets no red light assigned. Defaults to the minium of all observations.
#' @param max_value1 Allows the user to customize the value for column1 that gets maximum red light assigned. Defaults to the maximum of all observations.
#' @param min_value2 Allows the user to customize the value for column1 that gets no green light assigned. Defaults to the minium of all observations.
#' @param max_value2 Allows the user to customize the value for column1 that gets maximum green light assigned. Defaults to the maximum of all observations.
#' @param min_value2 Allows the user to customize the value for column1 that gets no blue light assigned. Defaults to the minium of all observations.
#' @param max_value2 Allows the user to customize the value for column1 that gets maximum blue light assigned. Defaults to the maximum of all observations.
